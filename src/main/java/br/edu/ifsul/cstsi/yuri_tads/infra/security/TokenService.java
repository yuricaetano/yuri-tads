package br.edu.ifsul.cstsi.yuri_tads.infra.security;

import br.edu.ifsul.cstsi.yuri_tads.usuario.Usuario;
import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.exceptions.JWTCreationException;
import com.auth0.jwt.exceptions.JWTVerificationException;
import br.edu.ifsul.cstsi.yuri_tads.infra.exception.TokenInvalidoException;
...
public class TokenService {
    ...
    public String geraToken(Usuario usuario){
        try {
            ...
            return JWT.create()
                .withIssuer("API Especies Exemplo de TADS")
